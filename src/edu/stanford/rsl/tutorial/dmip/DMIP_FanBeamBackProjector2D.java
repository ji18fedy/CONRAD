...
public class DMIP_FanBeamBackProjector2D {
    ...
    public Grid2D applyCosineWeights(Grid2D sino)
    {
        ...
        for(int i=0; i<detectorPixels; ++i){
            //TODO die gegebene Gleichnung darstellen.zuerst s dann ganze Geleichung 
        ...
        for (int t = 0; t < detectorPixels; ++t) {
            ...
            for (int b = 0; b < numProjs; ++b) {
                ...
                if (beta <= 2 * (delta - gamma)) {
                    //float val = 0; //TODO
                	//float val = Math.sin(Math.PI* beta/((4*-2*gamma)*4))*Math.sin(Math.PI* beta/((4*-2*gamma)*4))
    ...
    public static void main(String arg[])
    {
        ...
        String filename = "/proj/ciptmp/ji18fedy/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/Sinogram1.tif";
