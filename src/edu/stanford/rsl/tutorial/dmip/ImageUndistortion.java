...
public class ImageUndistortion{
	...
	public void doImageUndstortion(){
		...
		int caseNo = 0;
		String filename = "/proj/ciptmp/ji18fedy/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		
		if(caseNo == 0)
		{
			filename = "/proj/ciptmp/ji18fedy/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		}
		else if(caseNo == 1)
		{
			filename = "/proj/ciptmp/ji18fedy/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/undistorted.jpg";
		}else if(caseNo == 2)
		{
			filename = "/proj/ciptmp/ji18fedy/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame90.jpg";
		}
