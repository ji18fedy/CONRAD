...
public class Intro {
	...
	public static void gridIntro(){
		...
		// mit new eine image (Datentype: Grid2D) bauen
		...
		//Show ImageJ GUI
		// create GUI to inspect pixel values
		ImageJ ij = new ImageJ();
		//Display the image (TitelName:)
		image.show ("Circle image");
		
		//Copy an image
		// neue image (name: copy)bauen,Am INPUT geben wir die gebaute Image(name: image).
		Grid2D copy = new Grid2D (image);
		copy.show("Copy of circle");
		
		
		//Load an image from file
		String filename = "/proj/ciptmp/ji18fedy/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12.dcm";
		//TODO. Hint: Use IJ and ImageUtil
		// mrImage ist der Name der geladenen Image.
		Grid2D mrImage = ImageUtil.wrapImagePlus(IJ.openImage(filename)).getSubGrid(0);
		mrImage.show("loaded image");
		
		//convolution
		// Convolver unter dem Name conv bauen
		Convolver conv = new Convolver();
		// Convert Grid images to ImageJ ImageProcessors (unter dem Name ip)
		...
		String outFilename ="/proj/ciptmp/ji18fedy/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12out.tif";
		//IJ.save()
	...
	public static void basicIntro()
	{
		...
		M.setColValue(0,new SimpleVector(2,5,8));
		M.setColValue(0,new SimpleVector(3,6,9));
		...
		double matrixNormL2 = colVector.norm(VectorNormType.VEC_NORM_L2);
		System.out.println("||M||_F = " + matrixNormL1);
		System.out.println("||colVec||_2 = " + matrixNormL2);
